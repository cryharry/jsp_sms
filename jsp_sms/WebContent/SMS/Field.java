 ...
 */
public class Field extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Field() {}
	private Field( java.lang.ref.Reference ref ) {}

	private Field( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Field\"" );
	}

	/** Use this method only for creating a COM interface of type Field
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Field _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Field(obj);}
