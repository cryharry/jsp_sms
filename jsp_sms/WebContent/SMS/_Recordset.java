 ...
 */
public class _Recordset extends ezjcom.JComObject {
	...
	public native void Save(ezjcom.JComVariant Destination, SMS.PersistFormatEnum PersistFormat) throws ezjcom.JComException;
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private _Recordset() {}
	private _Recordset( java.lang.ref.Reference ref ) {}

	private _Recordset( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"_Recordset\"" );
	}

	/** Use this method only for creating a COM interface of type _Recordset
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static _Recordset _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new _Recordset(obj);}
