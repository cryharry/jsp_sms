 ...
 */
public class Fields15 extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Fields15() {}
	private Fields15( java.lang.ref.Reference ref ) {}

	private Fields15( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Fields15\"" );
	}

	/** Use this method only for creating a COM interface of type Fields15
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Fields15 _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Fields15(obj);}
