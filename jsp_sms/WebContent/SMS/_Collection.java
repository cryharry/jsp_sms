 ...
 */
public class _Collection extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private _Collection() {}
	private _Collection( java.lang.ref.Reference ref ) {}

	private _Collection( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"_Collection\"" );
	}

	/** Use this method only for creating a COM interface of type _Collection
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static _Collection _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new _Collection(obj);}
