 ...
 */
public class Recordset20 extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Recordset20() {}
	private Recordset20( java.lang.ref.Reference ref ) {}

	private Recordset20( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Recordset20\"" );
	}

	/** Use this method only for creating a COM interface of type Recordset20
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Recordset20 _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Recordset20(obj);}
