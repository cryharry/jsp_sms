 ...
 */
public class Parameters extends ezjcom.JComObject {
	...
	public native SMS._Parameter getItem(ezjcom.JComVariant Index) throws ezjcom.JComException;
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Parameters() {}
	private Parameters( java.lang.ref.Reference ref ) {}

	private Parameters( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Parameters\"" );
	}

	/** Use this method only for creating a COM interface of type Parameters
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Parameters _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Parameters(obj);}
