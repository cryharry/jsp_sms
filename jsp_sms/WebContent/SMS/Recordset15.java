 ...
 */
public class Recordset15 extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Recordset15() {}
	private Recordset15( java.lang.ref.Reference ref ) {}

	private Recordset15( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Recordset15\"" );
	}

	/** Use this method only for creating a COM interface of type Recordset15
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Recordset15 _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Recordset15(obj);}
