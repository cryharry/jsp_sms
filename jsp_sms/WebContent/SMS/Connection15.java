 ...
 */
public class Connection15 extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Connection15() {}
	private Connection15( java.lang.ref.Reference ref ) {}

	private Connection15( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Connection15\"" );
	}

	/** Use this method only for creating a COM interface of type Connection15
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Connection15 _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Connection15(obj);}
