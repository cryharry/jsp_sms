 ...
 */
public class Fields20 extends ezjcom.JComObject {
	...
	/** Constructors for internal EZ JCom Usage only
	  ...
	  */
	private Fields20() {}
	private Fields20( java.lang.ref.Reference ref ) {}

	private Fields20( ezjcom.JComObject obj ) throws ezjcom.JComException
	{
		if ( ! __JComLoad( obj, false ))
			throw new ClassCastException( "Object/interface passed does not support \"Fields20\"" );
	}

	/** Use this method only for creating a COM interface of type Fields20
	  * from another existing COM interface, when you know that it is possible.
	  */
	public static Fields20 _ezjcomCoerceObject(ezjcom.JComObject obj) throws ezjcom.JComException { return new Fields20(obj);}
